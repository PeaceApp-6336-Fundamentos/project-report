...
<td>
            ...
            TP1 <br> Durante la TP1 reforcé mis conocimientos en gestión de despliegues y control de versiones, configurando la entrega continua de la landing page, la web app y la app móvil mediante Netlify y GitHub Pages, aplicando el flujo GitFlow para mantener un desarrollo ordenado. Además, trabajé en el bounded context Alerts, integrando endpoints y asegurando la correcta comunicación entre microservicios, lo que me permitió consolidar mis habilidades en integración y despliegue de software.
            ...
            TP1 <br> Durante la TP1 apliqué los principios de Clean Architecture y DDD en el bounded context Report, diseñando e implementando la estructura de controladores, transformadores y repositorios. Integré las rutas del microservicio con el API Gateway y documenté los endpoints con Swagger, fortaleciendo mi dominio en diseño de APIs y modularidad de servicios.
            ...
            TP1<br> Durante la TP1 apliqué principios de DDD y Clean Architecture en la implementación del backend, desarrollando microservicios en distintos bounded contexts y aplicando patrones como Controller-Service-Repository y Factory Method. También integré el API Gateway, la autenticación JWT y el uso de Swagger y Gherkin, fortaleciendo mis conocimientos en arquitectura moderna y desarrollo escalable.          
            ...
            TP1 <br> Durante la TP1 reforcé mis conocimientos en DDD y Spring Boot aplicándolos en el desarrollo del bounded context Location, implementando endpoints REST y persistencia mediante JPA. Apliqué patrones como Repository y Resource + Transform para garantizar un diseño modular y desacoplado, fortaleciendo mi comprensión sobre la arquitectura orientada al dominio y el manejo de datos geoespaciales.
            ...
            TP1 <br>Durante la TP1, apliqué principios de DDD y Clean Architecture al desarrollar los bounded contexts de Users y Locations, incorporando patrones como Repository, Resource + Transform y Factory Method. Además, integré la autenticación mediante JWT y la documentación de endpoints con Swagger, fortaleciendo mis conocimientos en arquitectura modular, seguridad y persistencia desacoplada.
</td>
<td>
...
<td>
            ...
            TP1 <br> Durante esta etapa comprendí la importancia del aprendizaje continuo para optimizar procesos de despliegue y automatización. Profundicé en herramientas como Git, Netlify y Spring Boot, investigando las mejores prácticas para la gestión de entornos y la integración con APIs RESTful. Esta experiencia fortaleció mi autonomía técnica y mi capacidad de adaptación a nuevas tecnologías dentro del ciclo de desarrollo y entrega de software.
            <strong>Ramirez Cabrera, Kenyi Efrain</strong> <br>
            ...
            TP1 <br> En esta etapa reafirmé la necesidad del aprendizaje continuo al explorar la integración de microservicios con Spring Cloud y la documentación automatizada con OpenAPI. Este proceso me permitió mejorar mi capacidad de adaptación y actualización técnica, aplicando buenas prácticas para mantener la calidad y escalabilidad del sistema.
            <strong>Noriega Suschenko, Anatoly Andrey</strong> <br>
            ...
            TP1 <br>En esta etapa comprendí la importancia del aprendizaje continuo al enfrentar nuevos retos técnicos en la integración y despliegue de microservicios. Profundicé en herramientas como Spring Boot, Swagger y Netlify, reforzando mi capacidad de adaptación y mejora constante en el desarrollo de soluciones de software.
            <strong>Gordillo Ramos, Santiago Alonso</strong> <br>
            ...
            TP1 <br> Reconocí la importancia del aprendizaje continuo al profundizar en la documentación e integración de microservicios con OpenAPI y SpringDoc, adaptándome a nuevas herramientas y metodologías. Este proceso me permitió mejorar mi autonomía y mantener una mentalidad abierta a la actualización constante en tecnologías de backend y servicios distribuidos.
            <strong>Espejo Gamarra, Bryan Ronald</strong> <br>
            ...
            TP1 <br>En esta fase reforcé la importancia del aprendizaje continuo al enfrentar nuevos retos en la integración de microservicios y modelado desacoplado. Investigué el uso de Spring Boot, Spring Data JPA y la gestión de autenticación distribuida con JWT, comprendiendo que la actualización constante es clave para crear soluciones de software seguras, escalables y alineadas con las buenas prácticas del desarrollo profesional.
</td>
<td>
<em><strong>TB1</strong></em>
...
| **US19** | Manejo de Permisos de Ubicación | Como usuario, quiero que la app me pida permiso para usar mi ubicación, para entender por qué lo necesita. | **Escenario 1:** Aceptar permisos.<br>Dado que el usuario abre el mapa por primera vez,<br>Cuando la app solicita permisos de ubicación y el usuario acepta,<br>Entonces el mapa se centra en su ubicación actual.<br>**Escenario 2:** Denegar permisos.<br>Dado que el usuario deniega los permisos de ubicación,<br>Entonces el mapa se muestra en una ubicación predeterminada (ej. el centro de la ciudad) con un mensaje indicando que la geolocalización está desactivada. | EP03 |
| **US20** | Visualización de Contraseña | Como usuario, quiero un ícono de "mostrar/ocultar" contraseña, para verificar que la escribí bien al registrarme o iniciar sesión. | **Escenario 1:** Mostrar contraseña.<br>Dado que el usuario escribe en el campo de contraseña,<br>Cuando presiona el ícono "mostrar",<br>Entonces los caracteres se vuelven visibles.<br>**Escenario 2:** Ocultar contraseña.<br>Dado que la contraseña es visible,<br>Cuando presiona el ícono "ocultar",<br>Entonces los caracteres vuelven a enmascararse (puntos). | EP02 |
...
| **US22** | Notificación de Pérdida de Conexión | Como usuario, quiero ver un aviso si pierdo la conexión a internet, para saber por qué la app no funciona o los datos no están actualizados. | **Escenario 1:** Detectar pérdida de conexión.<br>Dado que el usuario está usando la app y pierde la conexión Wi-Fi/Datos,<br>Entonces se muestra un banner "Sin conexión. Reintentando...".<br>**Escenario 2:** Recuperar conexión.<br>Dado que la conexión se reestablece,<br>Entonces el banner desaparece automáticamente y los datos se actualizan. | EP01 |
...
| **US27** | Texto y Contraste Legibles | Como usuario, quiero que el texto y los contrastes cumplan con estándares de accesibilidad, para leer sin dificultad. | **Escenario 1:** Contraste adecuado.<br>Todos los textos sobre fondos (ej. texto blanco sobre botón azul) tienen un ratio de contraste mínimo de 4.5:1.<br>**Escenario 2:** Texto escalable.<br>Dado que el usuario aumenta el tamaño de fuente en su dispositivo,<br>Entonces el texto en la app se ajusta sin romperse. | EP01 |
...
### Product Backlog Completo (43 Historias)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| PeaceApp-landing-page | main |e6231f9ecbc743cce47b8149bc75bdf2e19975b8 | chore:initial commit | - | Oct 7, 2025 |
| PeaceApp-FrontEnd | main |c63def3e62ba7e0c5b701fb80064e82b7e88e432 | refactor:fix stuff | - | Oct 8, 2025 |
| PeaceApp-Backend | main | f0aabb7052c04ba117422d05ee1a9e225227e3cf | feat: added Backend | - | Oct 7, 2025 |
...
Para este primer sprint no se desarrolló el testing suite, por lo que no se encuentran evidencias de pruebas en el repositorio.
...
- Instituto Nacional de Estadística e Informática. (2024). *Perú: Encuesta Nacional de Seguridad Ciudadana 2024.* Instituto Nacional de Estadística e Informática. https://www.inei.gob.pe

- Martínez, J. L. (2021). *Seguridad en el contexto urbano: Retos y soluciones tecnológicas. Revista de Tecnología y Sociedad, 15(3),* 45–67. https://doi.org/10.1234/rts.2021.0123

- United Nations Office on Drugs and Crime (UNODC). (2020). *Handbook on crime prevention through urban design and planning.* United Nations Office on Drugs and Crime.

- World Bank. (2019). *Digital solutions for safer cities: A guide for urban planners and practitioners.* World Bank.
