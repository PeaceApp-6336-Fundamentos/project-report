...
| US07                    | Subir Evidencia Multimedia al Reporte                   | Como usuario, quiero poder seleccionar fotos o videos desde mi dispositivo y subirlos al formulario de reporte, para incluir evidencia visual del incidente.                                                                     | Escenario 1: Subida de archivo exitosa<br>Dado que el usuario ha seleccionado un archivo multimedia de tamaño permitido,<br>Cuando confirma la subida de evidencia,<br>Entonces el sistema inicia el proceso de carga del archivo al servidor y lo asocia al reporte.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | EP03                      |
| US08                    | Validación y Gestión de Evidencia Adjunta               | Como usuario, quiero que el sistema valide el tamaño y formato del archivo multimedia durante la subida, para prevenir errores y garantizar que la evidencia se procese correctamente.                                           | Escenario 1: Error por archivo demasiado grande<br>Dado que el usuario intenta subir un archivo que excede el límite de tamaño permitido,<br>Cuando intenta subir el archivo,<br>Entonces el sistema detiene la subida y muestra un mensaje indicando que el archivo no cumple con los requisitos.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | EP03                      |
| US09                    | Visualización de Reportes                               | Como ciudadano, quiero poder ver los reportes de otros usuarios sobre incidentes ocurridos en la zona, para estar al tanto de los eventos de seguridad.                                                                          | Escenario 1: Visualización de reportes recientes<br>Dado que el ciudadano está navegando por la aplicación,<br>Cuando accede a la opción de "ver reportes",<br>Entonces la aplicación muestra los reportes más recientes en la zona del ciudadano.<br><br>Escenario 2: Visualización de reportes en el mapa<br>Dado que el ciudadano está utilizando el mapa interactivo en la aplicación,<br>Cuando activa la opción de mostrar reportes en el mapa,<br>Entonces la aplicación superpone los reportes relevantes en el mapa, mostrando la ubicación exacta de cada incidente.                                                                                                                                                                                                                                                                            | EP03                      |
